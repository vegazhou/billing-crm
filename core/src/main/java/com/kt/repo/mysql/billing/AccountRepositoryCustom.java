...
public interface AccountRepositoryCustom {
    ...
    Page<CustomerAccountsBean> paginate(int curPage, SearchFilter search);

    Page<CustomerAccount> listAllByPage(int curPage, SearchFilter search);

    Page<AccountOperation> listAllByPageForDetail(int curPage, SearchFilter search);
}
