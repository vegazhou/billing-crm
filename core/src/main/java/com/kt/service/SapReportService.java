...
public class SapReportService {
    ...
    public List<SapBillItem> findSapPrepaidBillsByAccountPeriod(AccountPeriod accountPeriod, List<String> customerCodes) {
        return billFormalDetailRepository.listSapPrepaidBillReport(accountPeriod, customerCodes);
    }
