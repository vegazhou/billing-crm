...
import com.kt.common.dbhelp.util.WordUtils;
 ...
 * <p/>
 * 重写dbutils中“beanProcessor”的"mapColumnsToProperties"方法，
 * 使其可以实现数据表user_id到对象userId和user_id到对象属性user_id之间的自动转换。
 * 注：引用时需要注意的是平台优先处理“user_id到对象userId”。
 * <p/>
