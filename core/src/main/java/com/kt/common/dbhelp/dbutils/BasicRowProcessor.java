 ...
 */
package com.kt.common.dbhelp.dbutils;
...
public class BasicRowProcessor implements RowProcessor {
     ...
     *
     * @see com.kt.common.dbhelp.dbutils.RowProcessor#toArray(java.sql.ResultSet)
     ...
     * @see com.kt.common.dbhelp.dbutils.RowProcessor#toBean(java.sql.ResultSet, Class)
     * @see com.kt.common.dbhelp.dbutils.BeanProcessor#toBean(java.sql.ResultSet, Class)
     ...
     * @see com.kt.common.dbhelp.dbutils.RowProcessor#toBeanList(java.sql.ResultSet, Class)
     * @see com.kt.common.dbhelp.dbutils.BeanProcessor#toBeanList(java.sql.ResultSet, Class)
     * @param <T> The type of bean to create
     * @param rs ResultSet that supplies the bean data
     * @param type Class from which to create the bean instance
     * @throws java.sql.SQLException if a database access error occurs
     ...
     * @see com.kt.common.dbhelp.dbutils.RowProcessor#toMap(java.sql.ResultSet)
