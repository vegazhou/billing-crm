...
public class DefaultPageShow implements PageShow {
    ...
    /**
     *
     * @see com.kt.common.dbhelp.page.PageShow#getPageIndex(ListPage)
     */
    public String getPageIndex(ListPage<?> page) {
        ...
        if (pageCount >= 2) {
            ...
            if (curPage>1) {
                ret.append("<li><a href=\"javascript:np(")
    ...
    private String renderSingleLink(int num, int curPage) {
        ...
        if (num == curPage) {
            ...
            sb.append("<li><a href=\"javascript:np(")
                    .append(num)
                    .append(");\">")
                    .append(num)
                    .append("</a></li>");
