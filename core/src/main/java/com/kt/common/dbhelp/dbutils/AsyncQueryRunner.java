...
public class AsyncQueryRunner extends AbstractQueryRunner {
    ...
    protected class BatchCallableStatement implements Callable<int[]> {
         ...
         * @param ps The {@link java.sql.PreparedStatement} to be executed.
         */
         ...
         * @throws java.sql.SQLException if a database access error occurs or one of the commands sent to the database fails.
