...
/**
 * <code>StringRowProcessor</code> implementations convert
 * <code>ResultSet</code> rows into various other objects.  Implementations
 * can extend <code>BasicStringRowProcessor</code> to protect themselves
...
public interface StringRowProcessor {
    ...
    /**
     * Create an <code>String[]</code> from the column values in one
