package com.kt.common.dbhelp.page;
...
public class ListPagedStatement<T> extends AbstractPagedStatement<T> {
    ...
    public com.kt.common.dbhelp.page.ListPage<T> executeQuery(int type) throws SQLException {
        this.debug(0);
     ...
     * @return ListPage
     */
    public com.kt.common.dbhelp.page.ListPage<T> getListPage() {
        return this.listPage;
    }
