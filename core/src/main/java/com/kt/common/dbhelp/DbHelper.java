...
import com.kt.common.dbhelp.dbutils.*;
import com.kt.common.dbhelp.dbutils.handlers.*;
import com.kt.common.dbhelp.page.ListPage;
import com.kt.common.dbhelp.page.ListPagedStatement;
...
public class DbHelper {
     ...
     */
    protected static final Log sqllogger = LogFactory.getLog("com.kt.SQL");
     ...
     * 如果结果集有多行，则只返回首行对应的结果。
     * 如果结果集为空，则返回null。
     *
     * @param sql    执行的SQL语句
     * @param params 参数数组
     * @return 查询结果
     * @throws SQLException - if there is any problem executing the sql
     */
    ...
    /**
     * 带入指定的参数数组，执行 SELECT 语句，返回Map&#60;String, String&#62;类型的单行结果。
     * 如果结果集有多行，则只返回首行。
     * 如果结果集为空，则返回null。
     * 结果集中的null字段将转为空字符。
     *
    ...
    /**
     * 带入指定的参数数组，执行 SELECT 语句，返回Map&#60;String, Object&#62;类型的单行结果。
     * 如果结果集有多行，则只返回首行。
     * 如果结果集为空，则返回null。
     *
     * @param sql    即将被执行的sql语句
    ...
    /**
     * 带入指定的参数数组，执行 SELECT 语句，返回字符串数组类型的单行结果。
     * 如果结果集有多行，则只返回首行。
     * 如果结果集为空，则返回null。
     * 结果集中的null字段将转为空字符。
     *
    ...
    /**
     * 带入指定的参数数组，执行 SELECT 语句，返回对象数组类型的单行结果。
     * 如果结果集有多行，则只返回首行。
     * 如果结果集为空，则返回null。
     *
     * @param sql    即将被执行的sql语句
    ...
    /**
     * 给定SQL和指定的类，把字段映射到对应对象属性中，返回对象类型的单行结果。
     * 如果结果集有多行，则只返回首行。
     * 如果结果集为空，则返回null。
     * 字段属性映射按照java属性命名原则，例如 update_time 映射到 updateTime 属性。
     *
     * @param sql    即将被执行的sql语句
     * @param type   指定类
     * @param params 参数数组
    ...
    /**
     * 带入指定的参数数组，执行 SELECT 语句，返回Map&#60;String, String&#62;列表。
     * 如果结果集为空，则返回空列表。
     * 结果集中的null字段将转为空字符。
     *
     * @param sql    即将被执行的sql语句
    ...
    /**
     * 带入指定的参数数组，执行 SELECT 语句，返回Map&#60;String, Object&#62;列表。
     * 如果结果集为空，则返回空列表。
     *
     * @param sql    即将被执行的sql语句
     * @param params 参数数组
    ...
    /**
     * 带入指定的参数数组，执行 SELECT 语句，返回字符串数组列表。
     * 如果结果集为空，则返回空列表。
     * 结果集中的null字段将转为空字符。
     *
     * @param sql    即将被执行的sql语句
    ...
    /**
     * 给定SQL和指定的类，把字段映射到对应对象属性中，返回对象类型列表。
     * 如果结果集为空，则返回空列表。
     * 字段属性映射按照java属性命名原则，例如 update_time 映射到 updateTime 属性。
     *
     * @param sql    即将被执行的sql语句
     ...
     * @throws SQLException if a database access error occurs
     */
    public <T> ListPage<T> getAllPage(String sql, Class<T> clazz, int curPage, int pageSize) throws SQLException {
        ListPagedStatement<T> pst = new ListPagedStatement<T>(dialect, dataSource, sql, curPage, pageSize, true);
        pst.setClazz(clazz);
        return pst.executeQuery(99);
    }
