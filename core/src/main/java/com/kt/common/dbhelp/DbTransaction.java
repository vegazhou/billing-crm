...
import com.kt.common.dbhelp.dbutils.DbUtils;
import com.kt.common.dbhelp.dbutils.QueryRunner;
import com.kt.common.dbhelp.dbutils.handlers.BeanHandler;
import com.kt.common.dbhelp.dbutils.handlers.BeanListHandler;
import com.kt.common.dbhelp.dbutils.handlers.StringArrayHandler;
import com.kt.common.dbhelp.dbutils.handlers.StringArrayListHandler;
...
public class DbTransaction {
     ...
     */
    private static final Log sqllogger = LogFactory.getLog("com.cplatform.SQL");
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            dbc.execute("insert into t_sns_session (user_id, last_activity) values (?, ?)", new Object[]{3210, "20080920101111"});
            dbc.execute("insert into t_sns_session (user_id, last_activity) values (?, '20090102000000')", 3211);
            dbc.execute("insert into t_sns_session (user_id, last_activity) values (3212, '20090102000000')");
            
            tmp1 = dbc.find("select * from t_sns_session where user_id=? and user_id=?", new Object[]{3210,3210});
            System.out.println( org.apache.commons.lang.builder.ToStringBuilder.reflectionToString(tmp1) );
            
            tmp1 = dbc.find("select * from t_sns_session where user_id=?", 3211);
            System.out.println( org.apache.commons.lang.builder.ToStringBuilder.reflectionToString(tmp1) );
            
            tmp1 = dbc.find("select * from t_sns_session where user_id=3212");
            System.out.println( org.apache.commons.lang.builder.ToStringBuilder.reflectionToString(tmp1) );
            
            tmp2 = dbc.query("select * from t_sns_session");
            System.out.println( org.apache.commons.lang.builder.ToStringBuilder.reflectionToString(tmp2) );
            ...
            dbc.batch("insert into t_sns_session (user_id, last_activity) values (?, ?)", params);
            
            tmp2 = dbc.query("select * from t_sns_session");
            System.out.println( org.apache.commons.lang.builder.ToStringBuilder.reflectionToString(tmp2) );
            
            
            dbc.execute("delete from t_sns_session where user_id=? or user_id=?", new Object[]{3210, 3211});
            dbc.execute("delete from t_sns_session where user_id=?", 3212);
            dbc.execute("delete from t_sns_session1");
