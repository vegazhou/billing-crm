...
public class BasicStringRowProcessor implements StringRowProcessor {
     ...
     *
     * @see com.kt.common.dbhelp.dbutils.StringRowProcessor#toArray(java.sql.ResultSet)
     ...
     * @see com.kt.common.dbhelp.dbutils.StringRowProcessor#toMap(java.sql.ResultSet)
