...
import com.kt.common.dbhelp.dialect.PageSqlParserFactory;
...
public abstract class AbstractPagedStatement<T> {
     ...
     * @param pageSize 每页容量
     */
    public AbstractPagedStatement(String dialect, String sql, int currentPage, int pageSize, boolean queryCount) {
        this.currentPage = currentPage;
        this.pageSize = pageSize;
        this.startIndex = Page.getStartOfAnyPage(currentPage, pageSize);
        this.hasOffset = currentPage > 1;
