 ...
 */
public class CollisionDetectorWebExConfByTotalAttendees implements CollisionDetector {
    ...
    private CollisionDetectResult detectAgainst(WebExConfMonthlyPayByTotalAttendees c) {
        ...
        return CollisionDetectResult.error("同站点存在其他按总参会用户数计费产品");
    }
    ...
    private WebExConfMonthlyPayByTotalAttendees getChargeScheme() {
        return (WebExConfMonthlyPayByTotalAttendees) me.getChargeScheme();
    }
