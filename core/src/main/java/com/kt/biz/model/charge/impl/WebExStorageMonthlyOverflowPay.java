 ...
 */
public class WebExStorageMonthlyOverflowPay extends AbstractChargeScheme {
    ...
    public ChargeType getType() {
        return ChargeType.MONTHLY_PAY_BY_STORAGE_O;
    }

    @Override
    public void copyChargeElementFrom(AbstractChargeScheme scheme) {
        if (scheme instanceof WebExStorageMonthlyOverflowPay) {
            WebExStorageMonthlyOverflowPay src = (WebExStorageMonthlyOverflowPay) scheme;
