 ...
 */
public class CollisionDetectorCcCallCenterOls implements CollisionDetector {
    ...
    public CcCallCenterOlsMonthlyPayCharge getChargeScheme() {
        return (CcCallCenterOlsMonthlyPayCharge)me.getChargeScheme();
    }
}
