 ...
 */
public class CollisionDetectorCcCallCenterNumberMonthlyPay implements CollisionDetector {
    ...
    public CcCallCenterNumberMonthlyPayCharge getChargeScheme() {
        return (CcCallCenterNumberMonthlyPayCharge)me.getChargeScheme();
    }
}
