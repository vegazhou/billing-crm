 ...
 */
public class CollisionDetectorWebExStorage implements CollisionDetector {
    ...
    private CollisionDetectResult detectAgainst(WebExStorageMonthlyOverflowPay c) {
        ...
        return CollisionDetectResult.error("同站点存在可溢出计费的存储类产品");
    }
    ...
    private WebExStorageMonthlyPay getChargeScheme() {
        return (WebExStorageMonthlyPay) me.getChargeScheme();
    }
}
