 ...
 */
public class CcCallCenterMonthlyPayCharge extends AbstractChargeScheme {
    ...
    public ChargeType getType() {
        return ChargeType.CC_CALLCENTER_MONTHLY_PAY;
    }

    @Override
    public void copyChargeElementFrom(AbstractChargeScheme scheme) {
        if (scheme instanceof CcCallCenterMonthlyPayCharge) {
            CcCallCenterMonthlyPayCharge src = (CcCallCenterMonthlyPayCharge) scheme;
