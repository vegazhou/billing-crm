 ...
 */
public class WebExConfMonthlyPayByPorts extends AbstractChargeScheme {
    ...
    public ChargeType getType() {
        return ChargeType.MONTHLY_PAY_BY_PORTS;
    }

    @Override
    public void copyChargeElementFrom(AbstractChargeScheme scheme) {
        if (scheme instanceof WebExConfMonthlyPayByPorts) {
            WebExConfMonthlyPayByPorts src = (WebExConfMonthlyPayByPorts) scheme;
