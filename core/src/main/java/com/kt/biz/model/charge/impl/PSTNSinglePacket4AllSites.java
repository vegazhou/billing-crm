 ...
 */
public class PSTNSinglePacket4AllSites extends AbstractChargeScheme {

    private static final Logger LOGGER = Logger.getLogger(PSTNSinglePacket4AllSites.class);
    ...
    public ChargeType getType() {
        return ChargeType.PSTN_SINGLE_PACKET_FOR_ALL_SITES;
    }


    @Override
    public void copyChargeElementFrom(AbstractChargeScheme scheme) {
        if (scheme instanceof PSTNSinglePacket4AllSites) {
            PSTNSinglePacket4AllSites src = (PSTNSinglePacket4AllSites) scheme;
