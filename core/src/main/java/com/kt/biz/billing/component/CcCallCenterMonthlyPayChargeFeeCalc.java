 ...
 */
public class CcCallCenterMonthlyPayChargeFeeCalc extends FeeCalculator<CcCallCenterMonthlyPayCharge> {

    public CcCallCenterMonthlyPayChargeFeeCalc(OrderBean order, CcCallCenterMonthlyPayCharge chargeScheme) {
