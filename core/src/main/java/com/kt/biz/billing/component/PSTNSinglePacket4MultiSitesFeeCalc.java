 ...
 */
public class PSTNSinglePacket4MultiSitesFeeCalc extends FeeCalculator<PSTNSinglePacket4MultiSites> {
    public PSTNSinglePacket4MultiSitesFeeCalc(OrderBean order, PSTNSinglePacket4MultiSites chargeScheme) {
