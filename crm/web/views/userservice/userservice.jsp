...
<html lang="en-us">
										...
										<div class="row">
											...
											<section class="col col-3 form-group">
												...
												<label class="input"> <i class="icon-prepend fa fa-user"></i>
													<input type="text" name="s_sname" placeholder="请输入用户名" id="s_sname" data-pure-clear-button>
												</label>
											</section>
									...
									<form id="searchForm1" method="POST" action="#" class="smart-form" novalidate="novalidate" onsubmit="return search()">
										...
										<div class="row">												
											...
											<section class="col col-3 form-group">
												<label class="label text-left">用户名:</label>
												<label class="input"> <i class="icon-prepend fa fa-user"></i>
													<input type="text" name="s_sname1" placeholder="请输入用户名" id="s_sname1" data-pure-clear-button>
												</label>
											</section>
											...
											<section class="col col-3">
												...
												<span class="btn btn-primary btn-sm btn-search-user"><i class="fa fa-search"></i> 查询 </span>
					...
					<div class="modal-dialog" style="width:880px">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabeledit">用户修改</h4>
							</div>
							<div class="modal-body">
									...
									<fieldset>
											...
											<div class="row">
													...
													<section class="col col-5">
														<label class="input"> <i class="icon-prepend fa fa-user"></i>
															<input type="text" name="editusername" placeholder="请输入服务名称！" id="editusername" maxlength="200">
												...
												<section class="col col-1">
												<label class="label text-right"><input type="checkbox" class="editmc"></label></section>
												<section class="col col-2"><div class="">
												<label class="label text-left">网络会议(MC)</label></div>	
												</section>
												
												
												<section class="col col-1">
												<label class="label text-right"><input type="checkbox" class="editec"></label></section>
												<section class="col col-2"><div class="">
												<label class="label text-left">网络直播(EC)</label></div>	
												</section>
												
												 
												<section class="col col-1">
												<label class="label text-right"><input type="checkbox" class="edittc"></label></section>
												<section class="col col-2"><div class="">
												<label class="label text-left">在线培训(TC)</label></div>	
												</section>
												
												 
												<section class="col col-1">
												<label class="label text-right"><input type="checkbox" class="editsc"></label></section>
												<section class="col col-2"><div class="">
												<label class="label text-left">远程支持(SC)</label></div>	
												</section></div>
							...
							<div class="modal-footer">
								...
								<input type="hidden" id="edit_serviceid" value=""/>
	...
	<jsp:include page="../public/js.jsp" />
		...
		<c:if test="${Root == false}">	
		 ...
		 <script src="<c:url value="/static/js/page/userservice/userservice.js" />${randomstr}" type="text/javascript"></script>
