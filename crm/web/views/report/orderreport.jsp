			...
			<div id="content" style="height:100%">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 订单查询 <span>> 订单查询  </span></h1>
					</div>
									...
									<div class="widget-body no-padding">
										...
										<div class="row">
										  ...
										  <section class="col col-3 form-group">
												...
												<span class="btn btn-primary btn-sm btn-search"><i class="fa fa-search"></i> 刷新 </span>
...
<!-- Input Modal -->
	...
	<jsp:include page="../public/js.jsp" />
		...
		<script src="<c:url value="/static/js/page/report/orderreport.js" />${randomstr} " type="text/javascript"></script>
