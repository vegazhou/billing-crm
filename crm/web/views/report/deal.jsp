...
<body class="">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa-fw fa fa-home"></i> 管理后台 <span>> 用户分析</span>
				</h1>
			</div>
								...
								<form action class="smart-form  no-padding">
									<fieldset class="no-padding">
										...
										<div class="row" style="padding-top:0px;padding-bottom:0px;">
											<section class="col col-1">
												<label class="label text-right">报表开始日期：</label>
											</section>
											<section class="col col-2">
											...
											<section class="col col-1">
												<label class="label text-right">报表结束日期：</label>
											</section>	
											<section class="col col-2">
												<label class="text-left">
	...
	<script type="text/javascript"
		src="${ctx}/static/js/page/report/deal.js${randomstr}"
