...
<div id="content" style="height:100%">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 指令查询 <span>> 指令列表</span></h1>
    </div>
          ...
          <div class="widget-body no-padding">
            ...
            <div class="hide-tab-panel">
              <form id="searchForm" method="POST" action="#" class="smart-form" novalidate="novalidate" onsubmit="return search()">
				...
				<section class="col col-3 form-group">
                    <label class="label text-left">站点:</label>
                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                      <input type="text" name="s_sname" placeholder="请输入站点" data-pure-clear-button>
                    </label>
                  </section>
  ...
  <div class="modal-dialog" style="width:880px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabelcontract">详情</h4>
      </div>
                ...
                <fieldset>
                  <div class="row">
                    ...
                    <section class="col col-12">
                     <div id="detail" style="word-wrap:break-word"></div>
                    </section>
...
<script src="<c:url value="/static/js/page/report/webexrequest.js" />${randomstr}" type="text/javascript"></script>
