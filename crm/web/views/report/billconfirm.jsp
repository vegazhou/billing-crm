...
<html lang="en-us">
			...
			<div id="content" style="height:100%">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 账务管理 <span>> 账单确认 </span></h1>
					</div>
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						 ...
						 <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-c"
								...
								<div>
									...
									</div>	<div class="well well-sm well-light " id="wid-id-c2">
												<div class="btn-group btn-group-md">
												
					
												
														
													<span  class="btn btn-success btn-confirm">确认勾选的账单 </span><span  class="btn btn-warning btn-recalc-all">重计当月账单 </span>
	...
	<jsp:include page="../public/js.jsp" />
		...
		<script src="<c:url value="/static/js/page/report/billconfirm.js" />${randomstr} " type="text/javascript"></script>
