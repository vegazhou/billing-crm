...
<html lang="en-us">
			...
			<div id="content" style="height:100%">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 账务管理 <span>> 周期性费用明细</span></h1>
					</div>
										...
										<div class="row">
										  ...
										  <section class="col col-3 form-group" style="display:none">
												...
												<label class="input"> <i class="icon-prepend fa fa-user"></i>											
													<input type="text" name="s_sserviceid" placeholder="请输入客户名称" data-pure-clear-button id="s_sserviceid" disabled="true">	
												</label>
											</section>
											<section class="col col-3 form-group" style="display:none">
	...
	<jsp:include page="../public/js.jsp" />
		...
		<script src="<c:url value="/static/js/page/report/billcycledetail.js" />${randomstr} " type="text/javascript"></script>
