...
<html lang="en-us">
			...
			<div id="content" style="height:100%">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 站点订单查询 <span>> 订单列表</span></h1>
					</div>
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<div class="row">
											...
											<input type="hidden" name="s_siteid" id="s_siteid" placeholder="请输入客户名称" data-pure-clear-button>	
										</div>
									</form>		
									</div>	
	...
	<jsp:include page="../public/js.jsp" />
		...
		<c:if test="${Root == false}">	
		 ...
		 <script src="<c:url value="/static/js/page/report/onesitereport.js" />${randomstr} " type="text/javascript"></script>
