									...
									<div class="widget-body no-padding">  
										...
										<div class="row">
											...
											<section class="col col-1">
												...
												<span class="btn btn-primary btn-sm btn-search"><i class="fa "></i> 导出 Billing</span>
										
												<label class="label text-left">&nbsp;</label>
											
												<span class="btn btn-primary btn-sm btn-invoice"><i class="fa "></i> 导出 Invoice</span>
											...
											<label class="label text-left">&nbsp;</label>
												...
												<span class="btn btn-primary btn-sm btn-create-all"><i class="fa "></i> 生成 所有 PDF账单  </span>
											...
											<label class="label text-left">&nbsp;</label>
												...
												<span class="btn btn-primary btn-sm btn-export-all"><i class="fa "></i> 导出  所有 PDF账单  </span>
												
										
											
											<label class="label text-left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
											
												<span class="btn btn-primary btn-sm btn-sendmailall-all"><i class="fa "></i> 生成Invoice PDF  </span>
...
<!-- Input Modal -->
	...
	<jsp:include page="../public/js.jsp" />
		...
		<script src="<c:url value="/static/js/page/report/billexport.js" />${randomstr} " type="text/javascript"></script>
