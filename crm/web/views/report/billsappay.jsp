...
<html lang="en-us">
			...
			<div id="content" style="height:100%">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 账务管理 <span>> SAP客户回款</span></h1>
					</div>
	...
	<jsp:include page="../public/js.jsp" />
		...
		<script src="<c:url value="/static/js/page/report/billsappay.js" />${randomstr} " type="text/javascript"></script>
