			...
			<div id="content" style="height:100%">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 账户管理 <span>> 账户一览表  </span></h1>
					</div>
...
<!-- Input Modal -->
	...
	<jsp:include page="../public/js.jsp" />
		...
		<script src="<c:url value="/static/js/page/report/account.js" />${randomstr} " type="text/javascript"></script>
