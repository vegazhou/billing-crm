		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa-fw fa fa-home"></i> 资讯管理 <span>>查看资讯信息</span>
				</h1>
			</div>
			...
			<!-- widget content -->
				<div class="widget-body no-padding">
					<form  class="smart-form" novalidate="novalidate">
						...
						<fieldset>
							...
							<section class="col col-5">
								...
								<label class="input">
									...
									<input type="text" placeholder="请输入标题名称！" readonly class="required" maxlength="50" value="<%=request.getParameter("title")%>">
							...
							<section class="col col-5">
								<label class="label text_left" >
									...
									<select id="newsType" class="form-control required" disabled >
						...
						<div class="row">
							<section class="col col-5 staticUrlRow">
								<label class="label text_left">
									<font color=red>&nbsp;</font>页面地址：
								</label>
								<label class="input">
									<i class="icon-prepend fa fa-list-alt"></i>
									<input type="text" readonly class="required" value="<%=request.getParameter("staticUrl")%>">
									<span></span>
								</label>
							</section>
							<section class="col col-5 mobileRow" style="display:none">
								...
								<label class="input">
									<i class="icon-prepend fa fa-list-alt"></i>
									<input type="text" readonly value="<%=request.getParameter("mobileUrl")%>">
								</label>	
							</section>
						</div>
						<div class="row">
							<section class="col col-5 stitleRow" style="display:none">
								...
								<label class="input">
									<i class="icon-prepend fa fa-list-alt"></i>
									<input id="newsStitle" type="text" placeholder="请输入短标题名称！" class="required" readonly value="<%=request.getParameter("stitle")%>">
							...
							<section class="col col-2 boxRow" style="display:none">
								...
								<input type="checkbox" name="newsbox" id="box1" value="1" disabled> B端 &emsp; &emsp; &emsp; &emsp;
								<input type="checkbox" name="newsbox" id="box2" value="2" disabled> C端
								<span></span>
							</section>
						...
						<div class="row courseRow" style="display:none">
							<section class="col col-5">
								...
								<label class="input newsLink4">
									...
									<ul class="dropdown-menu" role="menu" style="z-index:999"></ul><span></span>
									<div id="linktxt" style="display:none"><font color="red">课程编号不能都空！</font></div>
								</label>
								<label class="input newsLink5" style="display:none">
									<i class="icon-prepend fa fa-list-alt"></i>
									<input id="newsLink5" class="form-control" type="text" placeholder="请选择课程信息！">
									<ul class="dropdown-menu" role="menu" style="z-index:999"></ul><span></span>
									<div id="linktxt" style="display:none"><font color="red">课程编号不能为空！</font></div>
								</label>
