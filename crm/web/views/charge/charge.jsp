...
<html lang="en-us">
			...
			<div id="content" style="height:100%">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 计费方案管理 <span>> 计费方案列表</span></h1>
					</div>
									...
									<div class="widget-body no-padding">  
										...
										<div class="row">
											...
											<section class="col col-3 form-group">
												<label class="label text-left">计费方案名称:</label>
												<label class="input"> <i class="icon-prepend fa fa-user"></i>
													<input type="text" name="s_sname" placeholder="请输入计费方案名称" data-pure-clear-button>
												</label>
											</section>
													...
													<section class="col col-4">
														<label class="input"> 
															...
															<select id="s_sserviceid" name="s_sserviceid" class="form-control">														
																...
																<option value="MONTHLY_PAY_BY_HOSTS">WebEx按用户数包月</option>
																<option value="MONTHLY_PAY_BY_PORTS">WebEx按并发数包月</option>
																<option value="MONTHLY_PAY_BY_TOTAL_ATTENDEES">WebEx按总参会人次包月</option>
																<option value="MONTHLY_PAY_BY_ACTIVEHOSTS">WebEx按激活用户数计费</option>
																<option value="EC_PAY_PER_USE">EC按次购买</option>
																<option value="EC_PREPAID">EC预存</option>
																<option value="MONTHLY_PAY_BY_STORAGE">WebEx存储包月</option>
																<option value="MONTHLY_PAY_BY_STORAGE_O">WebEx可溢出存储包月</option>
																<option value="CMR_MONTHLY_PAY">WebExCMR包月</option>
																<option value="PSTN_STANDARD_CHARGE">WebEx电话语音标准计费</option>
																<%--<option value="PSTN_PACKAGE_CHARGE">PSTN_PACKAGE_CHARGE</option>--%>
																<option value="PSTN_MONTHLY_PACKET">WebEx电话语音包月</option>
																<option value="PSTN_SINGLE_PACKET_FOR_MULTIPLE_SITES">WebEx电话语音增量包</option>
																<option value="PSTN_SINGLE_PACKET_FOR_ALL_SITES">WebEx电话语音增量包(覆盖全站点)</option>
																<option value="MONTHLY_PAY_PERSONAL_WEBEX">WebEx个人会议</option>
																<option value="PSTN_PERSONAL_CHARGE">个人电话语音</option>
																<option value="PSTN_PERSONAL_PACKET">个人电话语音包</option>
																<option value="TELECOM_CHARGE">电信会易通</option>
																<option value="MISC_CHARGE">杂项收费</option>
																<option value="CC_CALLCENTER_MONTHLY_PAY">天客云电话座席按用户包月</option>
																<option value="CC_CALLCENTER_NUMBER_MONTHLY_PAY">天客云中继号码按个数包月</option>
																<option value="CC_CALLCENTER_PSTN">天客云语音通话基础费率</option>	
																<option value="CC_CALLCENTER_PSTN_PACKAGE">天客云电话语音套餐包</option>								
																<option value="CC_CALLCENTER_PSTN_MONTHLY_PACKAGE">天客云电话语音包月</option>
																<option value="CC_CALLCENTER_OLS_MONTHLY_PAY">天客云在线座席按用户包月</option>						
																<option value="CC_PSTN_MONTHLY_MIN_CHARGE_PACKAGE">天客云最低月消费包</option>																							
																</select> 
	...
	<jsp:include page="../public/js.jsp" />
		...
		<c:if test="${Root == false}">	
		 ...
		 <script src="<c:url value="/static/js/page/charge/charge.js" />${randomstr} " type="text/javascript"></script>
