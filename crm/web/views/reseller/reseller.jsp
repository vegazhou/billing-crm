...
<div id="content" style="height:100%">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 分销商管理 <span>> 分销商列表</span></h1>
    </div>
              ...
              <form id="searchForm" method="POST" action="#" class="smart-form" novalidate="novalidate" onsubmit="return search()">
                <div class="row">
                  ...
                  <section class="col col-3 form-group">
                    <label class="label text-left">分销商名称:</label>
                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                      <input type="text" name="s_sname" placeholder="请输入分销商名称" data-pure-clear-button>
                    </label>
                  </section>
  ...
  <div class="modal-dialog" style="width:880px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">新增分销商</h4>
      </div>
                ...
                <fieldset>
                  <div class="row">
                    ...
                    <section class="col col-5">
                      <label class="input"> <i class="icon-prepend fa fa-user"></i>
                        <input type="text" name="sname" placeholder="请输入分销商名称！" id="sname" maxlength="100">
                        <b class="tooltip tooltip-top-left"> <i	class="fa fa-warning txt-color-teal"></i>分销商名称长度不大于100个! </b>
                        <span></span>
                      </label>
                    </section>
...
<script src="<c:url value="/static/js/page/reseller/reseller.js" />${randomstr}" type="text/javascript"></script>
