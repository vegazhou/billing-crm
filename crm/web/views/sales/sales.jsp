...
<html lang="en-us">
			...
			<div id="content" style="height:100%">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i>销售员管理 <span>> 销售员列表</span></h1>
					</div>
										...
										<div class="row">
											...
											<section class="col col-3 form-group">
												...
												<label class="input"> <i class="icon-prepend fa fa-user"></i>
													<input type="text" name="s_sname" placeholder="请输入销售员姓名" data-pure-clear-button>
												</label>
											</section>
					...
					<div class="modal-dialog" style="width:880px">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">添加销售员</h4>
							</div>
											...
											<fieldset>
												<div class="row">
													...
													<section class="col col-4">
														<label class="input"> <i class="icon-prepend fa fa-user"></i>
															<input type="text" name="sname" placeholder="请输入姓名！" id="sname" maxlength="100">
															<b class="tooltip tooltip-top-left"> <i	class="fa fa-warning txt-color-teal"></i>姓名长度不大于100个! </b>
															<span></span>
														</label>
													</section>
												</div>
										        ...
										        <div class="row">
													...
													<section class="col col-4">
														<label class="input"> <i class="icon-prepend fa fa-user"></i>
															<input type="text" name="semail" placeholder="请输入邮件！" id="semail" maxlength="100">
															<b class="tooltip tooltip-top-left"> <i	class="fa fa-warning txt-color-teal"></i>邮件长度不大于100个! </b>
															<span></span>
														</label>
													</section>
	...
	<jsp:include page="../public/js.jsp" />
		...
		<c:if test="${Root == false}">	
		 ...
		 <script src="<c:url value="/static/js/page/sales/sales.js" />${randomstr} " type="text/javascript"></script>
