...
<html lang="en-us">
	...
	<body class="">
			<div id="content" style="height:100%">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 直播课程管理 <span>> 直播课程列表</span></h1>
					</div>
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<%-- </c:if> --%> 
											...
											<!-- Toolbar End -->
										<table id="webinarDatatable" class="table table-bordered table-hover">
											<thead>
					...
					<div class="modal-dialog" style="width:900px;">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">添加直播课程</h4>
							</div>
										...
										<div class="well well-sm well-primary">
											...
											<fieldset>
												...
												<div class="row">
													...
													<section class="col col-5">
														<label class="input"> <i class="icon-prepend fa fa-user"></i>
															<input type="text" id="startTime" placeholder="点击选择日期" readonly/>
															<span></span>
														</label>
													</section>
												</div>
												...
												<div class="row">
													...
													<section class="col col-1">
														<label class="label text-right"> 
															<font color="red">&nbsp;</font> 现场地址:
														</label>
													</section>
													<section class="col col-5">
														<label class="input"> <i class="icon-prepend fa fa-user"></i>
															<input type="text" placeholder="请输入直播现场地址" id="location" maxlength="50">
															<b class="tooltip tooltip-top-left">
																<i class="fa fa-warning txt-color-teal"></i>
																字符长度不大于50个!
															</b>
												...
												<div class="row">
													<section class="col col-1">
														<label class="label text-right"> 
															<font color="red">*</font> 直播地址:
														</label>
													</section>
													<section class="col col-5">
														<label class="input"> <i class="icon-prepend fa fa-user"></i>
															<input type="text" placeholder="请输入直播地址URL" id="liveurl" maxlength="200">
															<b class="tooltip tooltip-top-left">
																<i class="fa fa-warning txt-color-teal"></i>
																字符长度不大于200个!
															</b>
													...
													<section class="col col-1">
														<label class="label text-right"> 
															<font color="red">*</font> 直播时长:
														</label>
													</section>
													<section class="col col-5">
														<label class="input"> <i class="icon-prepend fa fa-user"></i>
															<input type="text" placeholder="请输入直播时长,以分钟为单位" id="duration" maxlength="3">
															<b class="tooltip tooltip-top-left">
																<i class="fa fa-warning txt-color-teal"></i>
																请输入数字,范围为0-999!
															</b>
												...
												<div class="row">
													<section class="col col-1">
														<label class="label text-right"> 
															<font color="red">&nbsp;</font> 回放地址:
														</label>
													</section>
													<section class="col col-5">
														<label class="input"> <i class="icon-prepend fa fa-user"></i>
															<input type="text" placeholder="请输入回放地址URL" id="playbackurl" maxlength="200">
															<b class="tooltip tooltip-top-left">
																<i class="fa fa-warning txt-color-teal"></i>
																字符长度不大于200个!
															</b>
		...
		<!-- End Input Modal -->
				...
				<div class="modal fade" id="registCountModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog" style="width:900px;">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
									...
									<div class="col-md-12">
										<div class="well well-sm well-primary">
											...
											<fieldset>
												...
												<table id="registCountDataTable" class="table table-bordered table-hover">
													<thead></thead>
													<tbody></tbody>
													<tfoot></tfoot>
												</table>
	...
	<script src="<c:url value="/static/js/page/product/webinar.js"/>" type="text/javascript" charset="utf-8"></script>
