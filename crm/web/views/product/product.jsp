...
<html lang="en-us">
			...
			<div id="content" style="height:100%">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 产品管理 <span>> 产品列表</span></h1>
					</div>
											...
											<fieldset>
												...
												<div class="row ">
													...
													<section class="col col-4">
														...
														<input type="checkbox" name="isTrial" class="checkbox-item" id="isTrial" >
										 		...
										 		<div class="row ">
													...
													<section class="col col-4">
														...
														<input type="checkbox" name="isAgent" class="checkbox-item" id="isAgent" >
	...
	<jsp:include page="../public/js.jsp" />
		...
		<c:if test="${Root == false}">	
		 ...
		 <script src="<c:url value="/static/js/page/product/product.js" />${randomstr}" type="text/javascript"></script>
