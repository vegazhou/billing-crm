...
<html lang="en-us">
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> 管理后台 <span>> 热词管理</span></h1>
					</div>
										...
										<div class="row">
											...
											<section class="col col-3">
												...
												<select id="s_type" name="s_type" class="form-control">
													<option selected="selected" value="6">课程热词</option>
													<option value="8">分享热词</option>
													<option value="9">资讯热词</option>
													<option value="10">搜索热词</option>
												</select>
											</section>
					...
					<div class="modal-dialog" style="width:800px">
						<div class="modal-content">
										...
										<div class="well well-sm well-primary">
											...
											<fieldset>
												<div class="row">
													...
													<section class="col col-6">
														<label class="input"> <i class="icon-prepend fa fa-question-circle"></i>
															<input type="text" name="sdicnum" placeholder="不输入则自动生成！" id="sdicnum" >
															<span></span>
														</label>
													</section>
												</div>
												...
												<div class="row">
													...
													<section class="col col-6">
														<label class="label text-left" id="stypename"> 
														</label>														
													</section>	
												</div>
												...
												<div class="row">
													...
													<section class="col col-6">
														<label class="input"> <i class="icon-prepend fa fa-list-alt"></i>
															<input type="text" name="spriority" placeholder="权重" id="spriority" maxlength="3">
															<b class="tooltip tooltip-top-left"> <i	class="fa fa-warning txt-color-teal"></i>权重为介于0与100之间的整数!</b>
															<span></span>
														</label>
													</section>	
												</div>
							...
							<div class="modal-footer">
								...
								<input type="hidden" id="edit_dicid" value=""/>
	...
	<script src="<c:url value="/static/js/page/manage/managedic.js" /> " type="text/javascript" charset="utf-8"></script>
