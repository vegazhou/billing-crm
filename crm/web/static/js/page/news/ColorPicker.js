...
document.write("<div id='ColorPicker' style='z-index:9999;opacity:1;-moz-opacity:1;filter:alpha(opacity=100);position:absolute; left:0px; top:0px;background:#efefef;border:1px solid #cccccc;padding:10px 20px;display:none;'>")
document.write("<div id='divTitle' style='cursor: move;'><b>请选择背景色：</b></div>")
...
document.write("</table>")
document.write("<table style='margin-top:10px' height='20' border='0' cellpadding='0' cellspacing='2'><tr><td>选中的色彩：</td><td id='ShowColor' width='45' bgcolor='#7F7F7F'></td><td>&nbsp;&nbsp;基色：<SPAN id='RGB'>#7F7F7F</SPAN></td></tr>")
...
function CreateCPBtn(inputName){
    ...
    document.write("<img style=\"width:25px;height:25px\" src=\"../../static/img/Rect.gif\" style=\""+CPBtnStyle+"\" align=\"absmiddle\" onClick=\"showColorPicker(this,event,'"+inputName+"')\">")	
}
function showColorPicker(sBtnObj,event,inputName) {
	$$("ColorPicker").style.display="";
	$$("ColorPicker").style.top=(event.clientY+document.body.scrollTop-100)+"px";
	$$("ColorPicker").style.left=(event.clientX+30)+"px";
	theSBtnObj=sBtnObj;
