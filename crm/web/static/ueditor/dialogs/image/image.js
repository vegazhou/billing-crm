    ...
    UploadImage.prototype = {
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                var dataImgSrc = data.url.replace(newsUploadLocation, imgUploadedURI);
                list.push({
                    //src: editor.options.UEDITOR_HOME_URL +   prefix + '../' + data.url,
                    //_src: editor.options.UEDITOR_HOME_URL +  prefix + '../' +data.url,
                	src:dataImgSrc,
                	_src:dataImgSrc,
                    title: data.title,
                    alt: data.original,
